...
export const BUILD_PHASES: Phase[] = [
  ...
  { name: 'Phase 4 — Reports & Documents', total: 12, done: 9, status: 'progress', note: 'All 5 Reports leaves live -- try /reports. Dropped Task 11 (exact duplicate of a Phase 3 page).' },
